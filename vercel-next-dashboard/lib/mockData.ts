...
export type HealthMetric = { label: string; value: string; tone: Tone };
...
export const baseHealth: HealthMetric[] = [
...
export const baseCorridors: Corridor[] = [
